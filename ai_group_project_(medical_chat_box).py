# -*- coding: utf-8 -*-
"""AI_group_project_(Medical_chat_box_use_'bert').ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1TNKGmPb2_5Z88lustmZ1Zvjr-Geh2CrR
"""
...
class DrugRecommender:
  ...
  def recommend_drugs(self, condition, avoid_alcohol=False, threshold=0.4):
    ...
    matched_indices = []
    for idx in top_indices:
      if similarities[idx] > threshold:## The preset thereshold is 0.4, anybody can reset as a new thereshold
    ...
    if avoid_alcohol and 'alcohol' in recommendations.columns:
      recommendations = recommendations[recommendations['alcohol'].isin(['X'])]
...
class MedicalChatbot:
  ...
  def process_query(self, user_input, avoid_alcohol=False):
    ...
    drug_recommendations = self.drug_recommender.recommend_drugs(top_condition, avoid_alcohol)
